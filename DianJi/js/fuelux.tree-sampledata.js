...
mui.plusReady(function() {
		...
		$.ajax({
			...
			success: function(msg) {
				...
				if (msg.status == "SUCCESS") {
					...
					deMainVue.$data.devNameCus = isUndefined(info, 'devices_name') + ' ( ' +
						isUndefined(info, 'devices_no') +
						' ) ';
	...
	function setUIForCPX(simData, i) {
		...
		sensorStr += '<div class="tree-folder-name">' + isUndefined(simData, 'sim_name') + '传感器卡： ' + simData
			.serial_no +
		...
		if (simData.devices_company == 'A') {
			...
			sensorStr += '<li class="mui-table-view-cell">物联网卡号：' + isUndefined(simData, 'internet_things_no') +
				'</li>';
			...
			if (typeof(simData.mcc) == "undefined") {
				...
				sensorStr += '<li class="mui-table-view-cell">小区信息：' + simData.mcc + simData.mnc + '-' + simData
					.lac + '-' +
			...
			if (typeof(simData.signal_intensity) != 'undefined') {
				...
				if ((simData.signal_intensity > 1 || simData.signal_intensity == 1) && (simData.signal_intensity <
						8 || simData.signal_intensity ==
						8)) {
					sensorStr +=
				...
				if ((simData.signal_intensity > 9 || simData.signal_intensity == 9) && (simData.signal_intensity <
						12 || simData.signal_intensity ==
						12)) {
					sensorStr +=
				...
				if ((simData.signal_intensity > 13 || simData.signal_intensity == 13) && (simData.signal_intensity <
						17 || simData
						.signal_intensity == 17)) {
					sensorStr +=
				...
				if ((simData.signal_intensity > 18 || simData.signal_intensity == 18) && (simData.signal_intensity <
						20 || simData
						.signal_intensity == 20)) {
					sensorStr +=
				...
				if ((simData.signal_intensity > 21 || simData.signal_intensity == 21) && (simData.signal_intensity <
						25 || simData
						.signal_intensity == 25)) {
					sensorStr +=
				...
				if ((simData.signal_intensity > 26 || simData.signal_intensity == 26) && (simData.signal_intensity <
						31 || simData
						.signal_intensity == 31)) {
					sensorStr +=
			...
			if (simData.supply_type == 0 || simData.supply_type == undefined) {
				if (typeof(simData.dump_percentage) != "undefined") {
					...
					if ((simData.dump_percentage > 67 || simData.dump_percentage == 67) && simData.dump_percentage <
						84) {
						sensorStr +=
					...
					if ((simData.dump_percentage > 50 || simData.dump_percentage == 50) && simData.dump_percentage <
						67) {
						sensorStr +=
					...
					if ((simData.dump_percentage > 34 || simData.dump_percentage == 34) && simData.dump_percentage <
						50) {
						sensorStr +=
					...
					if ((simData.dump_percentage > 16 || simData.dump_percentage == 16) && simData.dump_percentage <
						34) {
						sensorStr +=
					...
					if ((simData.dump_percentage > 0 || simData.dump_percentage == 0) && simData.dump_percentage <
						16) {
						sensorStr +=
			...
			sensorStr += '<li class="mui-table-view-cell">固件版本：' + isUndefined(simData, 'software_version') +
				'</li>';
			...
			sensorStr += '<li class="mui-table-view-cell">最后一次连接服务器时间：' + isUndefined(simData.connectionVO,
					'connection_time') +
				'</li>';
			...
			if (simData.connect_model == '0') {
				...
				sensorStr +=
					...
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_0"  type="checkbox"><p>00:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_1"  type="checkbox"><p>01:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_2"  type="checkbox"><p>02:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_3"  type="checkbox"><p>03:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_4"  type="checkbox"><p>04:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_5"  type="checkbox"><p>05:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_6"  type="checkbox"><p>06:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_7"  type="checkbox"><p>07:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_8"  type="checkbox"><p>08:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_9"  type="checkbox"><p>09:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_10"  type="checkbox"><p>10:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_11"  type="checkbox"><p>11:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_12"  type="checkbox"><p>12:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_13"  type="checkbox"><p>13:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_14"  type="checkbox"><p>14:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_15"  type="checkbox"><p>15:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_16"  type="checkbox"><p>16:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_17"  type="checkbox"><p>17:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_18"  type="checkbox"><p>18:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_19"  type="checkbox"><p>19:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_20"  type="checkbox"><p>20:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_21"  type="checkbox"><p>21:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_22"  type="checkbox"><p>22:00:00</p></div>' +
					'<div><input disabled="disabled" name="item_' + i +
					'" id="chebox_23"  type="checkbox"><p>23:00:00</p></div>' +
					'</div> </li>';
				sensorStr += '<li class="mui-table-view-cell">数据上传时间：' + isUndefined(simData, 'upload_time_mode') +
					'</li>';
				sensorStr += '<li class="mui-table-view-cell">数据上传周期：' + isUndefined(simData, 'update_duration') +
					'</li>';
				sensorStr += '<li class="mui-table-view-cell">采集周期：' + isUndefined(simData, 'sampling_duration') +
					'</li>';
			}
			
			if (simData.connect_model == '1') {
				sensorStr += '<li class="mui-table-view-cell">采样间隔时间：' + isUndefined(simData, 'sampling_interval') +
					'  s</li>';
				sensorStr += '<li class="mui-table-view-cell">上传间隔时间：' + isUndefined(simData, 'upload_duration') +
					' s</li>';
				sensorStr += '<li class="mui-table-view-cell">心跳间隔时间：' + isUndefined(simData, 'heart_duration') +
					'  s</li>';
			}
			...
			for (var j = 0; j < simData.sensorList.length; j++) {
				...
				if (simData.devices_company == 'A') {
					...
					sensorStr += '<li class="mui-table-view-cell">传感器类型：' + isUndefined(sensorData,
						'yhd_sensor_mode') + '</li>';
					sensorStr += '<li class="mui-table-view-cell">通道号：' + isUndefined(sensorData,
						'yhd_channel_num') + '</li>';
				}
				else{
					sensorStr += '<li class="mui-table-view-cell">传感器名称：' + isUndefined(sensorData, 'sensor_name') +
						'</li>';
					sensorStr += '<li class="mui-table-view-cell">硬件版本：' + isUndefined(sensorData, 'version') +
						'</li>';
					sensorStr += '<li class="mui-table-view-cell">固件版本：' + isUndefined(sensorData, 'fw_version') +
						'</li>';
					sensorStr += '<li class="mui-table-view-cell">校准日期：' + isUndefined(sensorData,
						'calibration_time') + '</li>';
					sensorStr += '<li class="mui-table-view-cell">安装位置：' + isUndefined(sensorData, 'install_xy') +
						'</li>';
					sensorStr += '<li class="mui-table-view-cell">MODBUS地址：' + sensorData.topology_xy + '</li>';
					sensorStr += '<li class="mui-table-view-cell">传感器状态：' + chuanganqiStatus(sensorData
						.sensor_status) + '</li>';
					...
					if (simData.alarm_on_off == '1') {
						if (sensorData.sensorType != undefined && sensorData.sensorType == 'V') {
							sensorStr += '<li class="mui-table-view-cell">X轴预警值：' + isUndefined(sensorData,
									'threshold_early_x') +
								'  mm/s</li>';
							sensorStr += '<li class="mui-table-view-cell">X轴告警值：' + isUndefined(sensorData,
									'threshold_alarm_x') +
								'  mm/s</li>';
							sensorStr += '<li class="mui-table-view-cell">X轴危险值：' + isUndefined(sensorData,
									'threshold_danger_x') +
								'  mm/s</li>';
							sensorStr += '<li class="mui-table-view-cell">Y轴预警值：' + isUndefined(sensorData,
									'threshold_early_y') +
								'  mm/s</li>';
							sensorStr += '<li class="mui-table-view-cell">Y轴告警值：' + isUndefined(sensorData,
									'threshold_alarm_y') +
								'  mm/s</li>';
							sensorStr += '<li class="mui-table-view-cell">Y轴危险值：' + isUndefined(sensorData,
									'threshold_danger_y') +
								'  mm/s</li>';
							sensorStr += '<li class="mui-table-view-cell">Z轴预警值：' + isUndefined(sensorData,
									'threshold_early_z') +
								'  mm/s</li>';
							sensorStr += '<li class="mui-table-view-cell">Z轴告警值：' + isUndefined(sensorData,
									'threshold_alarm_z') +
								'  mm/s</li>';
							sensorStr += '<li class="mui-table-view-cell">Z轴危险值：' + isUndefined(sensorData,
									'threshold_danger_z') +
								'  mm/s</li>';
						}
					
						sensorStr += '<li class="mui-table-view-cell">温度预警值：' + isUndefined(sensorData,
								'threshold_temperature_early') +
							'  ℃</li>';
						sensorStr += '<li class="mui-table-view-cell">温度告警值：' + isUndefined(sensorData,
								'threshold_temperature') +
							'  ℃</li>';
						sensorStr += '<li class="mui-table-view-cell">温度危险值：' + isUndefined(sensorData,
								'threshold_temperature_danger') +
							'  ℃</li>';
					
					}
					
					if (sensorData.sensorType != undefined && sensorData.sensorType == 'V') {
						sensorStr += '<li class="mui-table-view-cell">信号采样模式：' + isUndefined(sensorData,
							'sampling_model') + '</li>';
						sensorStr += '<li class="mui-table-view-cell">量程：' + isUndefined(sensorData, 'range_data') +
							'</li>';
						sensorStr += '<li class="mui-table-view-cell">采样点数：' + isUndefined(sensorData,
							'sampling_number') + '</li>';
						sensorStr += '<li class="mui-table-view-cell">采样频率：' + isUndefined(sensorData,
							'sampling_frequency') + '</li>';
						sensorStr += '<li class="mui-table-view-cell">采样精度：' + isUndefined(sensorData,
							'sampling_accuracy') + '</li>';
						sensorStr += '<li class="mui-table-view-cell">传感器工作轴数：' + chuanganqiZhoushu(sensorData
							.working_axis) + '</li>';
						sensorStr += '<li class="mui-table-view-cell">传感器校准系数：' + isUndefined(sensorData,
				...
				if (msg.status == "SUCCESS") {
					...
					if (msg.data.photo_list != null) {
						...
						for (var i = 0; i < length; i++) {
							str = '<div class="swiper-slide"><img src=' + msg.data.photo_list[i]
								.photo_url + '></div>';
							var oli = $(str);
